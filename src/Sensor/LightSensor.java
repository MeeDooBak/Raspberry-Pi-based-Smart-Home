...
public class LightSensor implements GpioPinListenerDigital, SensorInterface {
    ...
    public LightSensor(int SensorID, int RoomID, String SensorName, boolean SensorState, PinsList GateNum, int SensorValue, Connection DB) {
        this.DB = DB;
    ...
    public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
        try {
            ...
            if (event.getState().isLow()) {
                ...
                FileLogger.AddInfo("LightSensor " + SensorID + ", State = true");
            ...
            FileLogger.AddWarning("LightSensor " + SensorID + ", Error In DataBase\n" + ex);
        }
    }
