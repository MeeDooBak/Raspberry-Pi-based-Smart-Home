...
public class DistanceMonitor {
    ...
    public static void main(String[] args) {
        ...
        command = new Relay("192.168.1.13", 161, "private");

        while (true) {
            try {
                int Distance = (int) Math.ceil(monitor.measureDistance());
                if (Distance <= 6) {
                    command.SNMP_SET(".1.3.6.1.4.1.19865.1.2.1." + 2 + ".0", SnmpAPI.INTEGER, "0");
                } else if (Distance >= 11) {
                    command.SNMP_SET(".1.3.6.1.4.1.19865.1.2.1." + 2 + ".0", SnmpAPI.INTEGER, "1");
                }
