...
public class LightTask implements Runnable, TaskInterface {
    ...
    public LightTask(int TaskID, String TaskName, UserList User, RoomList Room, SensorInterface SmokeSensor, boolean isDisabled, boolean repeatDaily,
