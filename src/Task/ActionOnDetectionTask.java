...
public class ActionOnDetectionTask implements Runnable {
    ...
    public ActionOnDetectionTask(int TaskID, String TaskName, UserList User, RoomList Room, Mail Mail, SensorList SmokeSensor, boolean isDisabled, boolean repeatDaily, int AlarmDuration, int AlarmInterval,
