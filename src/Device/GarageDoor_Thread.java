...
public class GarageDoor_Thread extends Thread {
    ...
    public GarageDoor_Thread(int DeviceID, boolean DeviceState, PinsList GateNum1, PinsList GateNum2, PinsList GateNum3, PinsList GateNum4, boolean isStatusChanged, int MaxValue,
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(GarageDoor_Thread.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
